...
class Car {
  ...
  PImage createCarImage() { //Creates Car (Add Pixel Image)
...
void keyPressed() { //Registers Commands for Car (A,D,Left Arrow, Right Arrow)
...
void drawHomeScreen() { //Pulls opening Screen Up
  background(#DBDBDB);
  fill(255);
  textAlign(CENTER);
  textSize(40);
